using DataFrames, Dash, DashHtmlComponents, DashCoreComponents, PlotlyJS, UrlDownload,Gadfly,Cairo


df = DataFrame(urldownload("https://raw.githubusercontent.com/NicJC/Datasets/main/Birth%20rate.csv"))
